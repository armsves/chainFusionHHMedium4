...
function Root() {
  ...
  const approveTransfer = async () => {
    try {
      ...
      const contract = new ethers.Contract("0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238", abi, signer);
  ...
  return (
    <main>
      ...
      <p>
        {walletAddress ? `The Injected provider Wallet Address is: ${walletAddress}` : 'Loading...'}
      </p>
      <button disabled={isApproving} onClick={approveTransfer}>Approve Transfer</button>

      <button disabled={isApproving} onClick={transferUsdc}>Transfer USDC</button>
    </main>
  );
}
